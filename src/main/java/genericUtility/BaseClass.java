...
public class BaseClass 
{
	...
	public WebDriver driver ;     // non static variable
	public static WebDriver sDriver;    // static variable  it is used only for Listeners
	...
	public void browserLaunch(@Optional("chrome") String BROSWER) throws IOException
	{
